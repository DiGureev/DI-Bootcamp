...
const Card = (props) => {
    ...
    return (
        <div className='cardBox' onClick={()=> checkClick()} style={{width: '25%', margin:'10px', height:'fit-content', border: '1px solid grey', padding: '5px', borderRadius: '10px', boxShadow: '2px 2px 5px grey'}}>
